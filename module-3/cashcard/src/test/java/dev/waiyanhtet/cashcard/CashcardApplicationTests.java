...
class CashcardApplicationTests {
	...
	@Test
	@DirtiesContext
	void shouldUpdatAndExistingCashCard() {
	...
	void shouldNotUpdateACashCardThatDoesNotExist() {
		CashCard unknownId = new CashCard(null, 19.99, null);
		HttpEntity<CashCard> request = new HttpEntity<>(unknownId);
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
	...
	@Test
	void shouldNotUpdateACashcardThatIsOwnBySomeoneElse() {
